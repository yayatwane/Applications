...
from media.fonctions import n_premiers, hexadeci, deci, euclide_etendu, crypter, decrypter, calc_2alpha, calc_o_alpha, calc_n_alpha, calc_G, calc_order_Gen, best_generator, hash_fichier
import re
...
#fichier = raw_input("Entrez le nom du fichier que vous souhaitez signer: ")
#texte1=hash_fichier(fichier)

def signer(caracteres,texte1,kerr,listex,listey,fichier):
	CRED = '\033[91m'
	CVRT = '\033[92m'
	CEND = '\033[0m'
	CBLU = '\033[94m'
	...
	print(CVRT+"Codes chiffres:"+CEND+" liste de points ",codec)
	print(CVRT+"\nMessage hexa chiffre:"+CEND, hexamessagec + "\n")
	print(CVRT+"Message chiffre:"+CEND, resultc)
	...
	new = path + new + signedLabel + extension
	# print(new)
